...
const overlay1887 = L.tileLayer("./data/tiles/1887/{z}/{x}/{y}.png", {
  attribution: "1887 Sanborn Map",
  ...overlayCommon,
}).addTo(map); // Default to 1887 map
const overlay1889 = L.tileLayer("./data/tiles/1889/{z}/{x}/{y}.png", {
  attribution: "1889 Sanborn Map",
  ...overlayCommon,
});
const overlay1905 = L.tileLayer("./data/tiles/1905/{z}/{x}/{y}.png", {
  ...
  .then((data) => {
    data.forEach((item) => {
      const popupContent = `
            ...
            <strong>Location Keywords:</strong> ${
              item.KeywordLocation || "N/A"
            }<br>
